...
import knlc.utils.UnicodeFontRenderer;
...
public class SplashProgress {
	...
	public static void drawSplash(TextureManager tm) {
		...
		GlStateManager.ortho(0.0D, (double)scaledResolution.getScaledWidth(), (double)scaledResolution.getScaledHeight(), 0.0D, 1000.0D,5000.0D);
		...
		if(splash == null) {
			splash = new ResourceLocation("knlc/splash.png");
		}
	...
	private static void drawProgress() {
		...
		if(ufr == null) {
			ufr = UnicodeFontRenderer.getFontOnPC("Consolas", 20);
		}
